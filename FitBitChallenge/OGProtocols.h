...
@protocol FBCGraphGesture<FBGraphObject>
...
@protocol FBCGraphThrowAction<FBOpenGraphAction>

@property (retain, nonatomic) id<FBCGraphGesture>    gesture;
@property (retain, nonatomic) id<FBCGraphGesture>    opposing_gesture;
...
@protocol FBCGraphPublishedThrowAction<FBOpenGraphAction>

@property (retain, nonatomic) id<FBCGraphThrowAction> data;
...
@protocol FBCGraphActionList<FBOpenGraphAction>
